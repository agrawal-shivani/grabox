...
<div class="row">
				<div class="coming_soon col-md-12 col-lg-12 col-sm-12 col-xs-12 " id="coming_soon">
											...
											<div class="bgimg">	
												  <div class="topleft">
												   ...
												   <div class="middle text-center">
												   	<h2>Coming Soon</h2>
												   	<hr width="150px">		
												    <p id="mydate" style="font-size:30px; height: ; width: 100%;"></p>
												  </div>
												...
												var countDownDate = new Date("Aug 30, 2018 10:00:00").getTime();
